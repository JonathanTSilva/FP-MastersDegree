...
\begin{document}
    ...
    \begin{frame}{OPC UA}{Processo de conexão segura}
        \begin{figure}
            \only<1>{\includegraphics[width=.7\textwidth]{seqConn-1.png}}
            \only<2>{\includegraphics[width=.7\textwidth]{seqConn-2.png}}
            \only<3>{\includegraphics[width=.7\textwidth]{seqConn-3.png}}
        \end{figure}
    \end{frame}

    \subsection{\textit{Cybersecurity}}

    \begin{frame}{Convergência TI/TO}
        \begin{figure}
