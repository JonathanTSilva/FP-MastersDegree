...
\titulo{Análise de vulnerabilidades em redes OPC UA industriais}
\titleabstract{Vulnerability analysis in industrial OPC UA networks}
\tituloresumo{Análise de vulnerabilidades em redes OPC UA industriais}
\autor{Jonathan Tobias da Silva}
\autorficha{Silva, Jonathan Tobias da}
\autorabr{SILVA, J. T. da}
...
\orientadorcorpoficha{orientador Ivan Nunes da Silva}
\orientadorficha{Silva, Ivan Nunes da, orient}
