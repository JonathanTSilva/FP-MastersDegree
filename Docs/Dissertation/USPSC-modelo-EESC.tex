...
oneside,  % para impressão em anverso (frente) e verso. Oposto a oneside/twoside - Nota: utilizar \imprimirfolhaderosto*
...
% Apêndices
% ----------------------------------------------------------
% \input{USPSC-TA-PosTextual/USPSC-Apendices}
...
% INDICE REMISSIVO
%--------------------------------------------------------------------
\input{USPSC-TA-PosTextual/USPSC-IndicesRemissivos}
